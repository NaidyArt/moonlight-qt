...
public:
    ...
    Q_PROPERTY(bool enableStatsTelemetry MEMBER enableStatsTelemetry NOTIFY enableStatsTelemetryChanged)
...
signals:
    ...
    void enableStatsTelemetryChanged();
