...
// Keep this variant's structured telemetry choice independent from official
// Moonlight while sharing the rest of the stream profile.
...
#ifdef Q_OS_DARWIN
    enableStatsTelemetry = settings.value(SER_STATS_TELEMETRY, true).toBool();
#else
    enableStatsTelemetry = false;
#endif
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_STATS_TELEMETRY, enableStatsTelemetry);
